    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="container mx-auto px-4 py-12 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          {[
            [t('home.hero.btn_shop'), <FaMobileAlt />, "/shop"],
            [t('home.hero.btn_hire'), <FaUsers />, "/hire-freelancers"],
            [t('home.hero.btn_tech'), <FaTools />, "/tech-services"],
            [t('home.hero.btn_rent'), <FaDesktop />, "/computer-rental"],
            [t('home.hero.btn_training'), <FaGraduationCap />, "/training-modules"],
        ...
        <div className="mb-16">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <h3 className="text-lg sm:text-xl font-bold text-gray-900">
              {timeRemaining.days} {t('home.hero.timer_day')}, {timeRemaining.hours} {t('home.hero.timer_hours')}
            </h3>
          </div>
          <p className="text-gray-600 text-sm sm:text-base">
            {t('home.hero.timer_range')}
          </p>
        </div>
      </section>
